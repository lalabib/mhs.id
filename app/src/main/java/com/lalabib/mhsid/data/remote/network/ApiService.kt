...
import com.lalabib.mhsid.utils.SharedObject.menuDetail
...
interface ApiService {
    ...
    @GET("/api/api_datamahasiswa.php?apikey=$apiKey&menu=$menuDetail")
    suspend fun getDetailMahasiswa(@Query("uniqueid") uniqueId: String): DetailDataMahasiswaResponse
}